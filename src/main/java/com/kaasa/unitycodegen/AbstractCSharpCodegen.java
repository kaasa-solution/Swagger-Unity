...
public abstract class AbstractCSharpCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public AbstractCSharpCodegen() {
        ...
        setReservedWordsLowerCase(Arrays.asList(
                ...
                "localVarHttpContentType", "localVarStatusCode",
                // C# reserved words
        ...
        languageSpecificPrimitives = new HashSet<String>(
                Arrays.asList("String", "string", "bool?", "double?", "decimal?", "int?", "long?", "float?", "byte[]",
                        ...
                        "Boolean", "Double", "Int32", "Int64", "Float", "Guid?", "System.IO.Stream", // not really a primitive, we include it to avoid model import
                        "Object"));
